...
&\textbf{27\, } & short-author papers published in major peer-reviewed journals\\
& & (out of which \textbf{7}\, first-authored papers and \textbf{5}\, lead by supervised student).\\
...
\end{tabular} }
\textcolor{mark_color}{\textbf{Total number of citations}}: >14400.
\textcolor{mark_color}{\textbf{h-index}}: 23 (using ADS and iNSPIRE).
\\
