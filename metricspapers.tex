...
&\textbf{33\, } & short-author papers published in major peer-reviewed journals\\
...
\end{tabular} }
\textcolor{mark_color}{\textbf{Total number of citations}}: >18400.
\textcolor{mark_color}{\textbf{h-index}}: 27 (from ADS and iNSPIRE record).
\\
