...
&\textbf{20\, } & short-author papers published in major peer-reviewed journals\\
& & (out of which \textbf{5}\, first-authored papers).\\
&\textbf{12} & collaboration papers, with substantial contribution, published in major peer-reviewed journals\\
&\textbf{5}& \, papers in submission stage,\\
&\textbf{2}& \, other publications (thesis, white papers, long-authorlist reviews)
\end{tabular} }
\textcolor{mark_color}{\textbf{Total number of citations}}: >11100.
\textcolor{mark_color}{\textbf{h-index}}: 22 (using ADS and iNSPIRE).
\\
