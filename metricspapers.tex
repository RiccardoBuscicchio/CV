...
&\textbf{19\, } & short-author papers published in major peer-reviewed journals\\
...
\end{tabular} }
\textcolor{mark_color}{\textbf{Total number of citations}}: >10000.
\textcolor{mark_color}{\textbf{h-index}}: 21 (using ADS and iNSPIRE).
\\
