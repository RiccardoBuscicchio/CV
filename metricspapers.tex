...
&\textbf{31\, } & short-author papers published in major peer-reviewed journals\\
& & (out of which \textbf{7}\, first-authored papers and \textbf{7}\, lead by supervised student).\\
...
\end{tabular} }
\textcolor{mark_color}{\textbf{Total number of citations}}: >15400.
\textcolor{mark_color}{\textbf{h-index}}: 24 (from ADS and iNSPIRE record).
\\
