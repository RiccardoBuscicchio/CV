...
&\textbf{28\, } & short-author papers published in major peer-reviewed journals\\
& & (out of which \textbf{7}\, first-authored papers and \textbf{6}\, lead by supervised student).\\
&\textbf{13} & collaboration papers with substantial contribution, published in major peer-reviewed journals\\
&\textbf{47} & collaboration papers in total, published in major peer-reviewed journals\\
&\textbf{8}& \, papers in submission stage,\\
&\textbf{2}& \, other publications (thesis, white papers, long-authorlist reviews)
\end{tabular} }
\textcolor{mark_color}{\textbf{Total number of citations}}: >15000.
\textcolor{mark_color}{\textbf{h-index}}: 24 (using ADS and iNSPIRE).
\\
