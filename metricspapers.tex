...
&\textbf{38\, } & short-author papers published in major peer-reviewed journals\\
& & (out of which \textbf{8}\, first-authored papers and \textbf{11}\, lead by supervised student).\\
&\textbf{14} & collaboration papers with substantial contribution, published in major peer-reviewed journals\\
...
\end{tabular} }
\textcolor{mark_color}{\textbf{Total number of citations}}: >19500.
\textcolor{mark_color}{\textbf{h-index}}: 28 (from ADS and iNSPIRE record).
\\
