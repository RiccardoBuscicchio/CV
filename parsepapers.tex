...
\vspace{-0.1cm}
{\footnotesize Supervised students publications marked with *.}
\vspace{0.1cm}
...
%
\end{longtable} }
\textcolor{color1}{\textbf{Short-author papers published in major peer-reviewed journals:}}
...
%
\end{longtable} }
\textcolor{color1}{\textbf{Collaboration papers, with substantial contribution, published in major peer-reviewed journals:}}
\vspace{-0.5cm}
...
%
\end{longtable} }
\textcolor{color1}{\textbf{Other publications:}}
\vspace{-0.5cm}
