...
%
\textbf{5.} & & \textit{Partial alignment between jets and megamasers: coherent or selective accretion?.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{LISA Definition Study Report.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{A weakly-parametric approach to stochastic background inference in LISA.}
\newline{}
F. Pozzoli, \textbf{R. Buscicchio}, C. J. Moore, A. Sesana, F. Haardt, A. Sesana.
\newline{}
\href{https://arxiv.org/abs/2311.12111}{arXiv:2311.12111 [astro-ph.CO].}
\vspace{0.09cm}\\
%
