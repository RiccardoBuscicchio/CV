...
\definecolor{color0}{rgb}{grey}
\definecolor{color1}{rgb}{0.0, 0.6, 0.6}
\definecolor{mark_color}{rgb}{0.3, 0.5, 0.5}
%\usepackage{cmbright}
...
\newcommand{\epjc}{European Physical Journal C\xspace}
\newcommand{\joss}{Journal of Open Source Software\xspace}
