...
\vspace{-0.1cm}
\begin{tabular}{rcl}
&\hspace{0.4cm} &$\circ\;\;${\textit{Activity}}: development of LISA data analysis ground-segment for the Italian Space Agency.
\end{tabular}
...
%mark_CVshort
\section{Skills}
\cvitem{Programming languages}{Python (advanced), Bash (advanced), Go, Stan, Julia, Mathematica, C.}
