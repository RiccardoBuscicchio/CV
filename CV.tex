...
$\quad$ Relativistic astrophysicist, developing advanced data analysis and statistical frameworks for Bayesian and frequentist inference. Applications include space-mission modelling, signal detection and parameter estimation in gravitational-wave astronomy, population inference, stochastic background searches.
}}
%mark_CVshort
