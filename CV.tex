...
$\circ\;$  Monthly Notices of the Royal Astronomical Society& $\circ\;$ Institute of Physics Trusted Reviewer Excellence program $\circ\;$ Classical and Quantum Gravity\\
\end{tabular}
...
%mark_CVshort
\section{Skills}
\cvitem{Programming languages}{Python (advanced), Bash (advanced), Julia, Mathematica, Go, R, Stan, C, Qt5.}
