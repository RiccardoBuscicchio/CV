...
\cvitemwithcomment{}{\phantom{\hspace{0.4cm}$\circ\;$} \textit{Content}: Introduction to gravitational-wave data analysis. Space-based and ground-based interferometers.}{}\vspace{-0.1cm}
\cvitemwithcomment{}{\phantom{\hspace{0.4cm}$\circ\;$} \textit{Content}: Space-based and ground-based interferometers.}{}\vspace{-0.1cm}
