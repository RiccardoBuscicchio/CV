...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ 
{EuroHPC PRACE Benchmark access}, 100k CPUh on Leonardo BOOSTER (grant ``LISAFIT'' no. EHPC-BEN-2023B08-024)}{2023}
\vspace{-0.1cm}

\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ 
{Google Cloud for Researchers}, 4k€ Google Cloud Research Credits (grant no.297563360)}{2023}
\vspace{-0.1cm}

\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ 
{CINECA ISCRA Type-C project}, 10k CPUh at the Italian National HPC center.}{2022}
\vspace{-0.1cm}
...
%mark_CVshort
\section{Skills}
\cvitem{Programming languages}{Python (advanced), Bash (advanced), Go, R, Stan, Julia, Mathematica, C.}
