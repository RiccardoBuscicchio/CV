...
\vspace{-0.1cm}
\begin{tabular}{rcl}
&\hspace{0.4cm} &$\circ\;\;${\textit{Support}}: development of LISA data analysis ground-segment for the Italian Space Agency.
\end{tabular}
...
\vspace{-0.1cm}
\begin{tabular}{rcl}
&\hspace{0.4cm} &$\circ\;\;${\textit{Supervisor}}: A.~Vecchio, C.~Moore. Thesis resulted in 6 short-author publications.
\\
